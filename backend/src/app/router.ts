...
import { registerPrescriptionRoutes } from "../api/v1/prescriptions/prescriptions.routes";
import { registerPrescriptionPdfRoutes } from "../api/v1/prescriptions/prescriptions.pdf.routes";
...
export function createApp() {
  ...
  registerPrescriptionPdfRoutes(app);
